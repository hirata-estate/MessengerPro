...
public class ModuleInfo {
    ...
    public static final int MIN_ORCA_VERSION = 321610181;
    public static final int MAX_ORCA_VERSION = 321610252;
    public static final String RECOMMENDED_ORCA_VERSION_STRING = "458.0.0.54.108";
