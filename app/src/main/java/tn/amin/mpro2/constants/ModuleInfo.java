...
public class ModuleInfo {
    ...
    public static final int MIN_ORCA_VERSION = 320009265;
    public static final int MAX_ORCA_VERSION = 320009331;
    public static final String RECOMMENDED_ORCA_VERSION_STRING = "450.0.0.43.109";
