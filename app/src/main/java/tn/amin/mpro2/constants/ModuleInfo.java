...
public class ModuleInfo {
    ...
    public static final int MIN_ORCA_VERSION = 323208846;
    public static final int MAX_ORCA_VERSION = 323409551;
    public static final String RECOMMENDED_ORCA_VERSION_STRING = "466.0.0.39.109";
