...
public class ModuleInfo {
    ...
    public static final int MIN_ORCA_VERSION = 320409631;
    public static final int MAX_ORCA_VERSION = 320608578;
    public static final String RECOMMENDED_ORCA_VERSION_STRING = "452.0.0.50.109";
