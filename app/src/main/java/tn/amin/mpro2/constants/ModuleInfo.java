...
public class ModuleInfo {
    ...
    public static final int MIN_ORCA_VERSION = 320210038;
    public static final int MAX_ORCA_VERSION = 320210121;
    public static final String RECOMMENDED_ORCA_VERSION_STRING = "451.1.0.59.109";
